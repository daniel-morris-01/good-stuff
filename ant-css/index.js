module.exports = {
  '@primary-color': '#6c8bef',
  '@success-color': '#ffffff',
  '@info-color': '#f4faee',
  '@highlight-color': '#000000',
  '@body-background': '#1a2032',
  '@component-background': '#252d47',
  '@icon-color-hover': 'transparent',
  '@heading-color': '#e0e1e4',
  '@text-color': '#c8d4f9',
  '@text-color-secondary': '#c8d5f1',
  '@heading-color-dark': '#e0e1e4',
  '@text-color-dark': '#f4faee',
  '@text-selection-bg': '#f4faee',
  '@border-color-base': '#606a88',
